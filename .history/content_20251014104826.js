    ...
    return `
      <div class="app-item" data-app-id="${app.appId}">
        ...
        <div class="app-detail" id="app-detail-${app.appId}" style="display: none;">
          <div style="padding: 12px; background: #2a2a2a; border-radius: 6px; margin-top: 8px; border: 1px solid #3a3a3a;">
            <div style="margin-bottom: 12px;">
              <div style="font-size: 12px; font-weight: bold; margin-bottom: 8px; color: #64b5f6;">📅 阶段时间表</div>
              
              <div style="margin-bottom: 8px; padding: 6px; background: #1a3a52; border-radius: 4px; border: 1px solid #2196f3;">
                <div style="font-size: 11px; font-weight: bold; margin-bottom: 3px; color: #64b5f6;">
              ...
              <div style="margin-bottom: 8px; padding: 6px; background: #1b3a1b; border-radius: 4px; border: 1px solid #4caf50;">
                <div style="font-size: 11px; font-weight: bold; margin-bottom: 3px; color: #81c784;">
              ...
              <div style="margin-bottom: 8px; padding: 6px; background: #4a3a1a; border-radius: 4px; border: 1px solid #ff9800;">
                <div style="font-size: 11px; font-weight: bold; margin-bottom: 3px; color: #ffb74d;">
            ...
            <div style="margin-bottom: 8px; padding: 8px; background: #3a2a1a; border-radius: 4px; border: 1px solid #ff6b35;">
