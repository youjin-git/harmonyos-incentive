        ...
        <div class="app-detail" id="app-detail-${app.appId}" style="display: none;">
          <div style="padding: 12px; background: #f9f9f9; border-radius: 6px; margin-top: 8px; border: 1px solid #e0e0e0;">
            <div style="margin-bottom: 12px;">
              <div style="font-size: 12px; font-weight: bold; margin-bottom: 8px; color: #1976d2; display: flex; align-items: center;">
            ...
            <div style="margin-bottom: 8px; padding: 8px; background: #fff; border-radius: 4px; border: 1px solid #ff6b35;">
              <div style="font-size: 12px; font-weight: bold; margin-bottom: 6px; color: #ff6b35; display: flex; align-items: center;">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" style="margin-right: 6px;">
...
function createSidebar() {
  ...
  info.innerHTML = `
    <div class="api-monitor">
      <h3 style="color: #ff6b35; display: flex; align-items: center;">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" style="margin-right: 6px;">
