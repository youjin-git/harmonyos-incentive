          ...
          <div style="padding: 12px; background: #2a2a2a; border-radius: 6px; margin-top: 8px; border: 1px solid #3a3a3a;">
            ...
            <div style="margin-bottom: 8px; padding: 8px; background: #3a2a1a; border-radius: 4px; border: 1px solid #ff6b35;">
              ...
              <div style="font-size: 11px; line-height: 1.8;">
                ...
                <div style="display: flex; justify-content: space-between; margin-top: 6px; padding-top: 6px; border-top: 1px solid rgba(255,215,0,0.3);">
                  <span style="font-weight: bold;">预估总激励:</span>
                  <span style="font-weight: bold; color: #ffd700; font-size: 13px;">¥${app.estimatedReward}</span>
                </div>
              </div>
            </div>
