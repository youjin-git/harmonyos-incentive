    ...
    <div style="margin-bottom: 15px; padding: 12px; background: #2a2a2a; border-radius: 8px; border: 1px solid #444;">
      ...
      <div style="font-size: 12px; margin-top: 5px;">
        <div style="display: flex; justify-content: space-between; margin: 4px 0;">
          <span>应用总数:</span>
          <span style="font-weight: bold; color: #81d4fa;">${appsMap.size} 个</span>
        </div>
        <div style="display: flex; justify-content: space-between; margin: 4px 0;">
          <span>总活跃用户:</span>
      ...
      <div style="margin-top: 8px; padding-top: 8px; border-top: 1px solid rgba(255,255,255,0.2); font-size: 11px;">
        ...
        <div style="display: flex; justify-content: space-between; margin: 3px 0;">
          <span>一阶段达标:</span>
          <span style="color: #2196f3;">${phase1Count}/${appsMap.size}</span>
        </div>
        <div style="display: flex; justify-content: space-between; margin: 3px 0;">
          <span>二阶段达标:</span>
          <span style="color: #ff9800;">${phase2Count}/${appsMap.size}</span>
        </div>
      </div>
